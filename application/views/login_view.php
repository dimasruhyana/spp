			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="<?php echo site_url('login/auth'); ?>" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate="Valid email is required">
						<input class="input100" type="text" name="username" autofocus autocomplete="off">
				...
				<div class="login100-more" style="background-image: url('assets/Login_v18/images/undraw_mobile_login.svg'); background-size:50%;">
				</div>
			</div>
		</div>
	</div>
